...
ALTER TABLE jt_student
    ADD CONSTRAINT FK_JT_STUDENT_ON_USER FOREIGN KEY (user_id) REFERENCES user (id);
...
ALTER TABLE product_orders_mapping
    ADD CONSTRAINT fk_proordmap_on_orders FOREIGN KEY (order_id) REFERENCES orders (id);

ALTER TABLE product_orders_mapping
    ADD CONSTRAINT fk_proordmap_on_product FOREIGN KEY (product_id) REFERENCES product (id);